...
function SignupForm() {
  ...
  return (
    <main className="min-h-screen flex items-center justify-center px-4 sm:px-8 md:px-12 bg-black/40 backdrop-blur-lg">
          ...
          <div className="w-full max-w-7xl">
            ...
            >
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                ...
                <div>
                  <label htmlFor="contact" className="text-white block mb-2">
                    Contact Number
                  </label>
                  <input
                    id="contact"
                ...
                <div>
                  <label htmlFor="street" className="text-white block mb-2">
                    Street Address
                  </label>
                  <input
                    id="street"
