...
const Home = () => {
  ...
  return (
    <div className="bg-gradient-to-b from-[#0B1225] via-[#382677] to-[#050913] flex flex-col min-h-screen backdrop-blur-xl">
      ...
      <div className="flex-1 flex justify-center items-center my-3">
        <img
          ...
          alt="Featured Food"
          className="h-[35vw] w-[35vw] sm:h-40 sm:w-40 md:h-48 md:w-48 object-cover rounded-full shadow-lg"
        />
      </div>
