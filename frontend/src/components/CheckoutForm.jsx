...
const CheckoutForm = ({ setSuccessPayment, loading, setLoading }) => {
    console.log("CheckoutForm props:", { setSuccessPayment, loading, setLoading });

    if (typeof setLoading !== "function") {
        console.error("❌ setLoading is not a function! Check how it is passed.");
    }
        ...
        <form onSubmit={handlePayment} className="space-y-4">
            ...
            <button
                ...
                className={`w-full py-3 rounded-lg font-medium ${
                    loading ? "bg-gray-400 cursor-not-allowed" : "bg-[#F97316] text-white hover:bg-[#eb7622]"
                }`}
            >
