...
const FAQ = () => {
  ...
  const handleFeedback = (categoryIndex, questionIndex, helpful) => {
    ...
    console.log(`Feedback recorded: ${helpful ? "Helpful" : "Not helpful"}`);
  };
        ...
        {faqData[activeCategory].map((item, questionIndex) => (
          ...
          >
            ...
            >
              ...
              {expandedQuestions[`${activeCategory}-${questionIndex}`] ? (
            ...
            {expandedQuestions[`${activeCategory}-${questionIndex}`] && (
              <div className="px-6 py-4 bg-gray-50">
                ...
                <div className="flex items-center gap-4 mt-4">
                  ...
                  <button
                    onClick={() =>
                      handleFeedback(activeCategory, questionIndex, true)
                    }
                  ...
                  <button
                    onClick={() =>
                      handleFeedback(activeCategory, questionIndex, false)
                    }
