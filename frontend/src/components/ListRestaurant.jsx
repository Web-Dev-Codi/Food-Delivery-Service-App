...
function ListRestaurant() {
  ...
  {
    /*container=min-h-screen bg-gradient-to-b from-red-900 via-gray-800 to-black max-w-[77.5rem] mx-auto px-5 md:px-10 lg:px-15 xl:max-w-[87.5rem] . You can also write the className in tailwind.config.js as container and add it here, not the whole set like this*/
  }
