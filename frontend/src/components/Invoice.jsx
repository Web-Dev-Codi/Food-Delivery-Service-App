		...
		<div className="flex flex-col items-center p-6">
			<div>
				<h1 className="text-2xl font-bold mt-10 mb-10">
					Thank you for your order! 🚚 Your order will be delivered
					soon. Your invoice is ready—feel free to download it for
					your records. We look forward to serving you again!
				</h1>
			</div>
			<div
				ref={invoiceRef}
