    ...
    const placeOrderOnMount = async () => {
      ...
      try {
        ...
        const response = await axios.post(
          `http://localhost:8000/payment/save-order/${cartId}`,
          {},
  ...
  return (
    <div className="flex flex-col items-center p-6">
      <h1 className="text-2xl font-bold mt-10 mb-10">
        Thank you for your order! 🚚 Your order will be delivered soon. Your invoice is ready—feel free to download it for your records. We look forward to serving you again!
      </h1>

      <div ref={invoiceRef} className="bg-white shadow-lg rounded-lg p-6 w-full max-w-2xl">
        <div className="text-center mb-6">
          <h1 className="text-2xl text-black font-bold">Four Flavours Express</h1>
          <p className="text-gray-600">Hauptstraße 123, 10115 Berlin, Germany</p>
