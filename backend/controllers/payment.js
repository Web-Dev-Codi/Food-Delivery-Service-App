...
export const createPaymentIntent = async (req, res) => {
 let{ amount } = req.body;
    ...
    console.log("Received amount before conversion:", amount, "Type:", typeof amount);

    // Convert to a number if it's a string
    amount = Number(amount);

    console.log("Received amount after conversion:", amount, "Type:", typeof amount);
    ...
    try {
        switch (event.type) {
            case 'payment_intent.succeeded':
                ...
                console.log("🔹 Looking for Payment Record with Intent ID:", paymentIntent.id);
